angular.module("ui.rCalendar.tpls", ["rcalendar/calendar.html","rcalendar/day.html","rcalendar/month.html","rcalendar/week.html"]);
...
angular.module("rcalendar/calendar.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("rcalendar/calendar.html",
    "<div ng-switch=\"calendarMode\">\n" +
    "    <div class=\"row calendar-navbar mt-2\">\n" +
    "        <div class=\"nav-left col-2\">\n" +
    "            <button type=\"button\" class=\"btn btn-default btn-sm\" ng-click=\"move(-1)\"><i\n" +
    "                    class=\"glyphicon glyphicon-chevron-left\"></i></button>\n" +
    "        </div>\n" +
    "        <div class=\"calendar-header col-8\">{{title}}</div>\n" +
...
angular.module("rcalendar/day.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("rcalendar/day.html",
    "<div>\n" +
...
angular.module("rcalendar/month.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("rcalendar/month.html",
    "<div>\n" +
...
angular.module("rcalendar/week.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("rcalendar/week.html",
    "<div>\n" +
